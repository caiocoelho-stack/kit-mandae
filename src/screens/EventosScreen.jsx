    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%',overflow:'hidden'}}>
      ...
      <div style={{flex:1,overflowY:'auto',padding:'0 40px 32px'}}>
                ...
                <div key={i} style={{
                  ...
                  {ev.vendedores && (
                    <div style={{marginTop:4,fontSize:10,display:'flex',alignItems:'center',gap:4}}>
                      <span style={{background:'rgba(99,102,241,0.1)',color:'#818cf8',padding:'2px 8px',borderRadius:10,fontWeight:600}}>👥 {ev.vendedores}</span>
                    </div>
                  )}
        ...
        <p style={{fontSize:11,color:'var(--md-muted)',textAlign:'center',marginTop:16}}>
          Calendário Nuvem Envio 2026 + Conecta D2C · atualiza da planilha
        </p>
      </div>
    </div>
  );
